<?php
if ( ! class_exists( 'Blog_Articles_Author_Info_Widget' ) ) {
	/**
	 * Adds Blog Articles Author Info Widget.
	 */
	class Blog_Articles_Author_Info_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$blog_articles_author_info_widget = array(
				'classname'   => 'adore-widget author-widget',
				'description' => __( 'Retrive Author Information Widget', 'blog-articles' ),
			);
			parent::__construct(
				'blog_articles_author_info_widget',
				__( 'Adore Widget: Author Info Widget', 'blog-articles' ),
				$blog_articles_author_info_widget
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			?>
			<div class="adore-widget-body-wrapper">
				<div class="adore-widget-body-wrap-inside">
					<?php
